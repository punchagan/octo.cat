...
BLOG_TITLE = "Octo.cat"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://octo.cat"
# This is the URL where nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://octo.cat"
BLOG_EMAIL = "me@octo.cat"
BLOG_DESCRIPTION = "A cat domain for punchagan"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ("/archive.html", "Arxiu"),
        ("/categories/index.html", "Etiquetes"),
        ("/rss.xml", "RSS feed"),
    ),
}
